...
const products_1 = __webpack_require__(40);
const customers_1 = __webpack_require__(434);
function run() {
...
function getCustomerName(max) {
    return randomize_1.randomize(max, customers);
}
